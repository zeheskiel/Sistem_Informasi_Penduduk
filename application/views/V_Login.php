...
<div class="wrapper fadeInDown" style="background-color: rgba(0, 142, 214, 0.2);">
  <div id="formContent">
    ...
    <!-- Login Form -->
    <form method="POST" action="<?php echo base_url();?>penduduk/login">
      ...
      <input type="submit" class="fadeIn fourth" style="background-color: blue;"  value="Log In">
    </form>

    <!-- Remind Passowrd -->
    <div id="formFooter">
      <a class="underlineHover" href="<?php echo base_url();?>index.php/penduduk/signup">Sign Up</a>
    </div>
